...
export default function Routes({ authorized, userType }) {
  const AdminRoutesList = () => [
    ...
    />,
    <AdminRoute
      key={RoutesPaths.admin.filters}
      path={RoutesPaths.admin.filters}
      component={Pages.AdminFilters}
      authorized={authorized}
      userType={userType}
    />,
    <AdminRoute
    ...
    />,
    <AdminRoute
      key={RoutesPaths.admin.dealersList}
      path={RoutesPaths.admin.dealersList}
      component={Pages.AdminDealersList}
      authorized={authorized}
      userType={userType}
    />,
    <AdminRoute
  ...
  const DealerRoutesList = () => [
    ...
    <AdminRoute
      ...
      component={Pages.DealerPersonal}
      authorized={authorized}
      userType={userType}
    />,
    <Route
